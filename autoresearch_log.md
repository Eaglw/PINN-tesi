...
## Iteration 83: Aggressive RAR Refinement\n- **Result**: **Discard** (L2: 0.011618). L additione frequente di molti punti ha instabilizzato il training.\n\n## Iteration 84: Late-Stage RAR Focus\n- **Hypothesis**: Aggiungere **50 punti** solo una volta a **2000 epoche**.\n- **Motivation**: Fornire a L-BFGS una griglia raffinata senza disturbare la convergenza globale iniziale di Adam.\n- **Expected Result**: L2 Error < 0.00635.\n
## Iteration 84: Late-Stage RAR Focus\n- **Result**: **Discard** (L2: 0.009065). Anche l additione singola di punti raffinati regredisce la precisione rispetto alla baseline Sobol.\n\n## Iteration 85: Ultra-High Data Supervision\n- **Hypothesis**: Incrementare `lambda_data` a **50.0** (con i soliti 50 punti di ancoraggio).\n- **Motivation**: Sfruttare la stabilità dei 50 punti analitici imponendo una precisione quasi assoluta in quelle coordinate, lasciando che la PDE uniformi la soluzione nel resto del dominio.\n- **Expected Result**: L2 Error < 0.00635.\n
## Iteration 85: Ultra-High Data Supervision\n- **Result**: **Discard** (L2: 0.008361). Il peso 50.0 ha causato un eccessivo focus locale sui punti di ancoraggio.\n\n## Iteration 86: Mid-Stage RAR Integration\n- **Hypothesis**: Eseguire un raffinamento RAR (50 punti) a **1500 epoche**.\n- **Motivation**: Fornire i punti raffinati a metà training per permettere ad Adam di assimilarli meglio rispetto al raffinamento tardivo (2000 epoche).\n- **Expected Result**: L2 Error < 0.00635.\n
## Iteration 86: Mid-Stage RAR Integration\n- **Result**: **Discard** (L2: 0.009476). L inserimento di punti raffinati a metà training non ha superato la baseline record.\n\n## Iteration 87: High-Density Physical & Boundary Strengthening\n- **Hypothesis**: Aumentare i punti di collocazione a **50x50** (2500 pts) e il `bc_weight` a **30.0**.\n- **Motivation**: Bilanciare una maggiore risoluzione fisica interna con un vincolo al bordo più forte per evitare la deriva riscontrata in test precedenti.\n- **Expected Result**: L2 Error < 0.00635.\n
