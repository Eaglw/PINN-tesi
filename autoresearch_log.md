...
- **Theoretical Assumption**: A slightly lower BC weight might allow the physics residual to exert more influence during the initial training phase, avoiding stiff optimization.
