...
- **Regola Tassativa su Git**: Non eseguire MAI `git push` senza che l'utente lo chieda o lo autorizzi espressamente. Salva sempre modifiche e commit solo in locale se non viene espressamente ordinato un push.