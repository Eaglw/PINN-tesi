...
# --- Training Goals ---
#DATASET_OPTIONS = ['giesekus_clean.pt', 'oldroydb_clean.pt']
DATASET_OPTIONS = ['giesekus_clean.pt']
...
for dataset_filename in DATASET_OPTIONS:
    DATASET_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dataset', dataset_filename)
    dataset_name_prefix = dataset_filename.replace('_clean.pt', '')
    print(f'\n=======================================================')
